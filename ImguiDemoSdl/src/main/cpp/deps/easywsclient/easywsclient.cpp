...
#else
    if (useSSL) {
        fprintf(stderr, "ERROR: Secure WebSocket not supported (SSL disabled)\n");
        closesocket(sockfd);
        return NULL;
    }
#endif
